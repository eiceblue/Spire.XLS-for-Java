...
public class calculateFormulas {
    public static void main(String[] args) throws IOException{
        // Create a new ByteArrayOutputStream object to store the formulas
        ByteArrayOutputStream buffer = writeFormulas();

        // Create a new ByteArrayInputStream from the buffer
        ...
        try {
            ...
            System.out.println("Sheet1!$B$3=" + b3.toString());
            System.out.println("Sheet1!$C$3=" + c3.toString());
            System.out.println("Sheet1!$B$3 + Sheet1!$C$3=" + value.toString());
        } finally {
            // Close the buffer and input stream in the final block
            if (buffer != null)
                buffer.close();
            inputStream.close();
        }
    }
    // Method to write formulas and return them in a ByteArrayOutputStream
    public static ByteArrayOutputStream writeFormulas() {
        Workbook workbook = new Workbook();
        ...
        // Set number values for test data
        ...
        // Set headings and formatting for formulas
        ...
        // Set different formulas and their results
        ...
        // Save workbook to a ByteArrayOutputStream
