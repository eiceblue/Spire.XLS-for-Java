...
public class writeFormulas {
    public static void main(String[] args) {
        ...
        // Initialize variables for tracking current row and formula
        int currentRow = 1;
        String currentFormula = "";

        // Set column widths for specific columns in the worksheet
        sheet.setColumnWidth(1, 32);
        sheet.setColumnWidth(2, 16);
        sheet.setColumnWidth(3, 16);

        // Set values for specific cell ranges in the worksheet
        sheet.getCellRange(currentRow++, 1).setValue("Examples of formulas :");
        sheet.getCellRange(++currentRow, 1).setValue("Test data:");

        // Apply formatting to a specific cell range in the worksheet
        ...
        // Set numeric values for specific cells in the worksheet
        ...
        // Set labels for formula examples in the worksheet
        ...
        // Apply formatting to the formula labels cell range in the worksheet
        range.getCellStyle().getExcelFont().isBold(true);
        range.getCellStyle().setKnownColor(ExcelColors.LightGreen1);
        range.getCellStyle().setFillPattern(ExcelPatternType.Solid);
        range.getCellStyle().getBorders().getByBordersLineType(BordersLineType.EdgeBottom).setLineStyle(LineStyleType.Medium);

        // Set formulas and text values for specific cells in the worksheet
        ...
        // Specify the output file path and save the workbook in Excel 2013 format
